...
@NgModule({
    declarations: [FormClientComponent, ClientsContainerComponent, ClientCollectionComponent],
    imports: [CommonModule, ClientsRoutingModule, FormsModule, ReactiveFormsModule, SharedModule],
